  ...
  return (
    <div className='available-locations'>
      ...
      <svg
        ...
        {/* Use Link component with dynamic routes */}
        {locations[0] && (
          <Link to={`/location/${locations[0].id}`}>
            <polygon
              id='venue1'
        ...
        {locations[1] && (
          <Link to={`/location/${locations[1].id}`}>
            <polygon
              id='venue2'
        ...
        {locations[2] && (
          <Link to={`/location/${locations[2].id}`}>
            <polygon
              id='venue3'
        ...
        {locations[3] && (
          <Link to={`/location/${locations[3].id}`}>
            <polygon
              id='venue4'
